...
import ae.azoolportal.azoolstore.interfaces.OnRegisterCallback;
...
public class RegisterActivity extends AppCompatActivity implements View.OnClickListener, OnRegisterCallback {
    ...
    EditText et_name, et_email, et_phone, et_password, et_confirm_password;
    Button btn_register;
            ...
            if (!name.isEmpty())
            {
                ...
                if(!email.isEmpty())
                {
                    if(Patterns.EMAIL_ADDRESS.matcher(email).matches())
                    {
                            ...
                            if(!pass.isEmpty())
                            {
                                if(!confirmpass.isEmpty())
                                {
                                    ...
                                    if(pass.equals(confirmpass))
                                    {
                                        ...
                                        //ServiceRequest.getInstance(getApplicationContext()).addToRequestQueue(customRequest.register(PublicValues.URL_REGISTER,this, name, email, phone, pass));
                        ...
                        {
                            Toast.makeText(this,"Pls enter your phone number", Toast.LENGTH_LONG).show();
                        }
