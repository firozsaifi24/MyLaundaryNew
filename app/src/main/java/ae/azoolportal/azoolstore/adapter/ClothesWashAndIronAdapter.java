...
public class ClothesWashAndIronAdapter extends RecyclerView.Adapter {
    ...
    public ClothesWashAndIronAdapter(Context mContext, ArrayList<Clothes> adsArrayList, OnSubtractCallback onSubtractCallback, OnAdditionCallback onAdditionCallback) {
    ...
    private class AdsHolder extends RecyclerView.ViewHolder implements View.OnClickListener
    {
        ...
        public void onClick(View v) {
            ...
            if(v==img_subtract)
            {
                onSubtractCallback.onSubtractSuccess("2", getAdapterPosition());
            }

            if(v==img_addition)
            {
                onAdditionCallback.onAdditionSuccess("2", getAdapterPosition());
            }
