...
public class ClothesPremiumLaundryAdapter extends RecyclerView.Adapter {
    ...
    public ClothesPremiumLaundryAdapter(Context mContext, ArrayList<Clothes> adsArrayList, OnSubtractCallback onSubtractCallback, OnAdditionCallback onAdditionCallback) {
    ...
    private class AdsHolder extends RecyclerView.ViewHolder implements View.OnClickListener
    {
        ...
        public void onClick(View v) {
            ...
            if(v==img_subtract)
            {
                onSubtractCallback.onSubtractSuccess("4", getAdapterPosition());
            }

            if(v==img_addition)
            {
                onAdditionCallback.onAdditionSuccess("4", getAdapterPosition());
            }
