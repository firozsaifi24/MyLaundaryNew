...
public class ClothesDryCleanAdapter extends RecyclerView.Adapter {
    ...
    public ClothesDryCleanAdapter(Context mContext, ArrayList<Clothes> adsArrayList, OnSubtractCallback onSubtractCallback, OnAdditionCallback onAdditionCallback) {
    ...
    private class AdsHolder extends RecyclerView.ViewHolder implements View.OnClickListener
    {
        ...
        public void onClick(View v) {
            ...
            if(v==img_subtract)
            {
                onSubtractCallback.onSubtractSuccess("5", getAdapterPosition());
            }

            if(v==img_addition)
            {
                onAdditionCallback.onAdditionSuccess("5", getAdapterPosition());
            }
