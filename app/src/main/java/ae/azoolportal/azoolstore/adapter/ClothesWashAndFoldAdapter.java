...
public class ClothesWashAndFoldAdapter extends RecyclerView.Adapter {
    ...
    public ClothesWashAndFoldAdapter(Context mContext, ArrayList<Clothes> adsArrayList, OnSubtractCallback onSubtractCallback, OnAdditionCallback onAdditionCallback) {
