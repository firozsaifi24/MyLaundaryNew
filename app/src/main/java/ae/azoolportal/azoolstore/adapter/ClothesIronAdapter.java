...
public class ClothesIronAdapter extends RecyclerView.Adapter {
    ...
    public ClothesIronAdapter(Context mContext, ArrayList<Clothes> adsArrayList, OnSubtractCallback onSubtractCallback, OnAdditionCallback onAdditionCallback) {
    ...
    private class AdsHolder extends RecyclerView.ViewHolder implements View.OnClickListener
    {
        ...
        public void onClick(View v) {
            ...
            if(v==img_subtract)
            {
                onSubtractCallback.onSubtractSuccess("3", getAdapterPosition());
            }

            if(v==img_addition)
            {
                onAdditionCallback.onAdditionSuccess("3", getAdapterPosition());
            }
