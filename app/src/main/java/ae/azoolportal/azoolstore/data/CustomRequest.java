package ae.azoolportal.azoolstore.data;
...
public class CustomRequest {
    ...
    public StringRequest register(String url, final OnRegisterCallback onRegisterCallback, final String name, final String email, final String phone, final String password)
    {
